...
const Register = () => {
  ...
  return (
    <div className='px-5 xl:px-32 my-20 flex justify-center'>
      <form onSubmit={handleSubmit} className="relative z-10 w-[90%] max-w-xl bg-white/70 rounded-xl backdrop-blur-xl border p-10 shadow-[0_0_40px_#c0eaff60] animate-fadeIn">
