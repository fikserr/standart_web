                ...
                <div key={i} className="flex flex-col gap-3">
                    ...
                    <div>
                        <h3 className="font-oswald text-sm md:text-base font-normal">
                            Kuz mavsumi uchun barcha ayollar kiyimlariga
                            chegirmalarni taqdim etamiz
                        </h3>
                        <p className="font-oswald text-sm md:text-base">
                            Biz aksiyani boshlaymiz. Yozdan boshlab kuzga
                            tayyorlaning. Yoz davomida ayollar kuzgi kiyimlarini
                            chegirmali narxlarda xarid qiling.
                        </p>
                    </div>
                    <div className="flex items-center justify-between">
