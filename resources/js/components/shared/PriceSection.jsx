                        ...
                        <div className='grid sm:grid-cols-3 gap-10'>
                            ...
                            <div className='flex flex-col sm:mb-2 lg:mb-10 gap-10 col-span-3'>
                                <h2
                                    ...
                                    className="font-oswald text-center text-5xl lg:text-7xl min-h-[60px]"
                                >
                                    Narxni hisoblash
                                </h2>
                                <p
                                    
                                    className='font-oswald text-center sm:text-xl lg:text-2xl'
                                >
                        ...
                        <div>
                            <div className='flex items-center gap-4'>
                                ...
                                <span
                                    ...
                                    className='font-oswald sm:text-xl'
                                >
